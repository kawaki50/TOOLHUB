...
try {
    ...
    $query = "SELECT c.id_categories, c.nom as categorie, COUNT(p.id_produits) as nombre_produits FROM categories c LEFT JOIN produits p ON c.id_categories = p.id_categories GROUP BY c.id_categories, c.nom ORDER BY c.nom;";
