    ...
    return (
        ...
        <div className="home_page ">
            ...
            <div className="home_txt ">
                <h2 style={{textAlign: 'start'}}>COLLECTION ÉTÉ – BRICOLAGE<br/>Collection 2025</h2>
                ...
                <button style={{position: 'absolute',borderRadius:'0px',padding:'25px'}}><a href="#sellers">SHOP NOW</a><i className='bx bx-right-arrow-alt'></i></button>
